...
function ShowAllAlgos(Img1,Img2)
    ...
    imshow(Ref,[]);
    title("(c)")
    A = uint8(ImgSubstraction(Img1,Img2,4,8,[512 512],@SSIAFA1));
    subplot(2,4,4);
    imshow(A,[]);
    title("(d)")
    A = uint8(ImgSubstraction(Img1,Img2,4,8,[512 512],@SSIAFA2));
    subplot(2,4,5);
    imshow(A,[]);
    title("(e)")
    A = uint8(ImgSubstraction(Img1,Img2,4,8,[512 512],@SSIAFA3));
    subplot(2,4,6);
    imshow(A,[]);
    title("(f)")
    A = uint8(ImgSubstraction(Img1,Img2,4,8,[512 512],@SSIAFA4));
    subplot(2,4,7);
    imshow(A,[]);
    title("(g)")
end
...
function ShowOneAlgo(Img1,Img2,fun)
    ...
    imshow(A,[]);
    title("(d)")
    A = uint8(ImgSubstraction(Img1,Img2,2,8,[512 512],fun));
    subplot(2,4,5);
    imshow(A,[]);
    title("(e)")
    A = uint8(ImgSubstraction(Img1,Img2,3,8,[512 512],fun));
    subplot(2,4,6);
    imshow(A,[]);
    title("(f)")
    A = uint8(ImgSubstraction(Img1,Img2,4,8,[512 512],fun));
    subplot(2,4,7);
    imshow(A,[]);
    title("(g)")
    A = uint8(ImgSubstraction(Img1,Img2,5,8,[512 512],fun));
    subplot(2,4,8);
    imshow(A,[]);
    title("(h)")
end
...
function [PSNR, MSSIM] = calculateMetrics(Img1,Img2,fun)
    ...
    C = uint8(ImgSubstraction(Img1,Img2,3,8,[512 512],fun));
    D = uint8(ImgSubstraction(Img1,Img2,4,8,[512 512],fun));
    E = uint8(ImgSubstraction(Img1,Img2,5,8,[512 512],fun));
