...
ShowAllAlgos(Img1,Img2,6)
%ShowOneAlgo(Img1,Img2,@SSIAFA2)
%[PSNR, MSSIM] = calculateMetrics(Img1,Img2,@SSIAFA3)
...
function Out = ApprAddition2(Int1, Int2, k, n, fun)
    ...
    Out = uint8(bit2int(Sum,n+1,false)/2);
end
...
% Algorithm
    ...
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),1,8,[256 256],fun));
    B = uint8(ImgAddition2(uint8(Img1),uint8(Img2),2,8,[256 256],fun));
    C = uint8(ImgAddition2(uint8(Img1),uint8(Img2),3,8,[256 256],fun));
    D = uint8(ImgAddition2(uint8(Img1),uint8(Img2),4,8,[256 256],fun));
    E = uint8(ImgAddition2(uint8(Img1),uint8(Img2),5,8,[256 256],fun));
...
% Shows One Algorithms with Different Approximation Degrees
    ...
    imshow(A,[]);
    title("(d)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),2,8,[256 256],fun));
    subplot(2,4,5);
    imshow(A,[]);
    title("(e)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),3,8,[256 256],fun));
    subplot(2,4,6);
    imshow(A,[]);
    title("(f)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),4,8,[256 256],fun));
    subplot(2,4,7);
    imshow(A,[]);
    title("(g)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),5,8,[256 256],fun));
    subplot(2,4,8);
    imshow(A,[]);
    title("(h)")
end

function ShowAllAlgos(Img1,Img2,k)
...
% an Approximation Degree of 4/8
    ...
    imshow(Ref,[]);
    title("(c)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),k,8,[256 256],@SSIAFA1));
    subplot(2,4,4);
    imshow(A,[]);
    title("(d)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),k,8,[256 256],@SSIAFA2));
    subplot(2,4,5);
    imshow(A,[]);
    title("(e)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),k,8,[256 256],@SSIAFA3));
    subplot(2,4,6);
    imshow(A,[]);
    title("(f)")
    A = uint8(ImgAddition2(uint8(Img1),uint8(Img2),k,8,[256 256],@SSIAFA4));
    subplot(2,4,7);
    imshow(A,[]);
    title("(g)")
end
